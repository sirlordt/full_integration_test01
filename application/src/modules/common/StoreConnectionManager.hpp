...
public:
  ...
  static bool init_stores_connections( Common::JSONElementArray &stores_connections_config_list );
  static bool init_stores_connections_alias( Common::JSONElementObject &stores_connections_alias_config_list );
